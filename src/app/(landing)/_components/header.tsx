...
const Header = () => {
  return (
    ...
    <header className="fixed top-0 w-full border-b border-b-slate-200 dark:border-b-slate-700 h-14 z-50 bg-slate-900 bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-10">
